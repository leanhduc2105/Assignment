...
Thiết kế mạnh mẽ, kết cấu bền vững</p>
        ...
        <li class="one">
            <h5>Khách Hàng<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="MAKH" DataSourceID="SqlDataSource1" Height="50px" Width="125px" AllowPaging="True" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
        ...
        <li class="two">
            <h5>Sản Phẩm<asp:DetailsView ID="DetailsView2" runat="server" AllowPaging="True" AutoGenerateRows="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="MASP" DataSourceID="SqlDataSource2" Height="50px" Width="125px">
                <EditRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
                <Fields>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [SANPHAM] WHERE [MASP] = @MASP" InsertCommand="INSERT INTO [SANPHAM] ([MASP], [MALSP], [DONVITINH], [TENSP], [GIASP], [MOTA], [ANH]) VALUES (@MASP, @MALSP, @DONVITINH, @TENSP, @GIASP, @MOTA, @ANH)" SelectCommand="SELECT [MASP], [MALSP], [DONVITINH], [TENSP], [GIASP], [MOTA], [ANH] FROM [SANPHAM]" UpdateCommand="UPDATE [SANPHAM] SET [MALSP] = @MALSP, [DONVITINH] = @DONVITINH, [TENSP] = @TENSP, [GIASP] = @GIASP, [MOTA] = @MOTA, [ANH] = @ANH WHERE [MASP] = @MASP">
                    <DeleteParameters>
        ...
        <li class="three">
            <h5>Chi tiết hóa đơn<asp:DetailsView ID="DetailsView3" runat="server" AllowPaging="True" AutoGenerateRows="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="MCTHD" DataSourceID="SqlDataSource3" Height="50px" Width="125px">
                <EditRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
                <Fields>
        ...
        <li class="four">
            <h5>Loại sản phẩm<asp:DetailsView ID="DetailsView4" runat="server" AllowPaging="True" AutoGenerateRows="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="MALSP" DataSourceID="SqlDataSource4" Height="50px" Width="125px">
                <EditRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
                <Fields>
        ...
        <li class="five">
            <h5>Hóa đơn<asp:DetailsView ID="DetailsView5" runat="server" AllowPaging="True" AutoGenerateRows="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="MAHD" DataSourceID="SqlDataSource5" Height="50px" Width="125px">
                <EditRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
                <Fields>
